          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <p className="mb-8 text-pretty text-lg leading-relaxed text-muted-foreground sm:text-xl max-w-2xl">
                IPC, ICL, UVA, UVI, CER, ICC, CBA, CBT, Riesgo País, SMVM, personas desaparecidas, combustibles, medicamentos, diputados nacionales, datos censales y más. Sin autenticación, sin barreras.
              </p>
            </motion.div>
